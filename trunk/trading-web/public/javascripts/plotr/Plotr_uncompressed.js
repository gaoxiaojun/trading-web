	    ...
	    if (this.options.drawYAxis) {
	        if (this.yticks) {
				var collectYLabels = function(tick) {
					...
					var width = this.options.padding.left - this.options.axisTickSize * 2;	
					var spanName = partialName(tick[1],width/5);
		...
		if(this.options.drawXAxis) {
	        if(this.xticks) {
				var collectXLabels = function(tick) {
	                ...
	                var label = document.createElement('div');
	                var spanName = partialName(tick[1], this.options.axisLabelWidth/5);
	                label.appendChild(spanName);
